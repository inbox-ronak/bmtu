        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="float-right"><a href="<?php echo base_url();?>admin/Announcement/add" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus text-xs"></i> Add Announcement</a></div>
              <?php } ?>
            </div>
            <!-- /.card-header -->
    ...
    $(document).ready(function(){
        ...
        function show_data(){
          $('#modal-loader').modal('hide');
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/announcement/data')?>',
                async : true,
                //dataType : 'json',
        ...
        $('#btn_save').on('click',function(event){
            ...
            var formData = new FormData(form);
              $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('admin/announcement/add')?>",
                  data: formData,
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/announcement/getEdit')?>/'+id,
                dataType : 'html',
                success : function(data){
                  $('#editModel').html(data);
                  slug();
        ...
        //update record to database
         $('#btn_update').on('click',function(event){
            ...
            var formData = new FormData(form);
              $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('admin/announcement/update')?>",
                  data: formData,
                  //use contentType, processData for sure.
                  contentType: false,
                  processData: false,
        ...
        $('#show_data').on('click','.item_delete',function(){
            ...
            if(confirm('Are you sure want to delete?')){
              $.ajax({
                  type : "POST",
                  url: "<?php echo base_url();?>admin/announcement/delete/"+id,
                  dataType : "JSON",
                  data : {id:id},
                  success: function(msg){
                      success_msg(msg.success,msg.message);
    ...
    text_editor();
        ...
        function row_position(){
          ...
          function updateOrder(data) {
              $.ajax({
                  url:"<?php echo base_url();?>admin/announcement/ordering",
                  type:'post',
                  data:{position:data},
                  success:function(data){
