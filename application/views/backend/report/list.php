...
<?php $add_permission = $this->permission->grant(REPORT,'add'); ?>
<?php $edit_permission = $this->permission->grant(REPORT,'edit'); ?>
<?php $delete_permission = $this->permission->grant(REPORT,'delete'); ?>
<style type="text/css">
  .row_position tr{
    cursor: grab;
  }
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="float-right"><a href="#" data-toggle="modal" data-target="#modal-default" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus text-xs"></i> Add Report</a></div>
              <?php } ?>
            </div>
            <!-- /.card-header -->
    ...
    <div class="modal fade" id="modal-default" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>report/add' id="add-form" name="add-form" enctype='multipart/form-data'>
    ...
    <div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
        <div class="modal-content">
          <form data-toggle="validator" role="form" method='POST' class="form-horizontal2" action='<?php echo base_url();?>report/update_report' id="edit-form" name="edit-form" enctype='multipart/form-data'>
          <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function show_data(){
          $('#modal-loader').modal('hide');
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/Report/data')?>',
                async : true,
                //dataType : 'json',
        ...
        $('#btn_save').on('click',function(event){
            ...
            var formData = new FormData(form);
              $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('admin/report/add')?>",
                  data: formData,
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/report/getEdit')?>/'+id,
                dataType : 'html',
                success : function(data){
                  $('#editModel').html(data);
                  // edit();
        ...
        //update record to database
         $('#btn_update').on('click',function(event){
            ...
            var formData = new FormData(form);
              $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('admin/report/update')?>",
                  data: formData,
                  //use contentType, processData for sure.
                  contentType: false,
                  processData: false,
        ...
        $('#show_data').on('click','.item_delete',function(){
            ...
            if(confirm('Are you sure want to delete?')){
              $.ajax({
                  type : "POST",
                  url: "<?php echo base_url();?>admin/report/delete/"+id,
                  dataType : "JSON",
                  data : {id:id},
                  success: function(msg){
                      success_msg(msg.success,msg.message);
    ...
    function row_position(){
      ...
      function updateOrder(data) {
          $.ajax({
              url:"<?php echo base_url();?>admin/report/ordering",
              type:'post',
              data:{position:data},
              success:function(data){
