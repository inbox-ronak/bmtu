            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="file_type" class="col-sm-2 control-label"> File Type <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                        ...
                        if (isset($sliderdata) && !empty($sliderdata) && !empty($sliderdata[0]['file_name'])) {
                             ...
                             $image_path = getImagePath() . 'uploads/homepage_slider/thumb/' . $file_name_view;
                        ...
                        <?php 
                            ...
                            foreach ($langArr as $key => $val) { 
                                ...
                                ?> 
                                <div class="form-group">
                                    <label for="link" class="col-sm-2 control-label">Button Link &nbsp;<small style="color: blue; font-weight: bold;"><i>[<?= $val; ?>]:</i></small></label>
                        ...
                        <div class="form-group" id="slider_label_div" >
                            <label for="link" class="col-sm-2 control-label">Button Label</label>
                            <div class="col-sm-4">
                                <?php
                                if (isset($sliderdata) && !empty($sliderdata)) {
                                    $slide_order = $sliderdata[0]['label'];
                                } else if (isset($_POST['label']) && !empty($_POST['label'])) {
                                    $slide_order = $_POST['label'];
                                } else {
                                    $slide_order = "";
                                }
                                $order = array(
