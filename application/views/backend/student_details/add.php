...
<?php $add_permission = $this->permission->grant(STUDENT_DETAILS,'add'); ?> 
<?php $edit_permission = $this->permission->grant(STUDENT_DETAILS,'edit'); ?>
<?php $delete_permission = $this->permission->grant(STUDENT_DETAILS,'delete'); ?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Student Details</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/StudentDetails">Student Details</a></li>
            <li class="breadcrumb-item active"><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Student Details</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="table-responsive" id="show_data">
              ...
              <h3 class="card-title"><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Student Details</h3>
            </div>
            <!-- /.card-header -->
              <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>admin/StudentDetails/<?php if(isset($record['id'])){ echo 'edit/'.base64_encode($record['id']);}else{ echo 'add'; } ?>' id="add-form" name="add-form" enctype='multipart/form-data'>
                <div class="row">
                  <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $.ajax({
        type : "POST",
        url: "<?php echo base_url();?>admin/StudentDetails/fetchDepartment",
        dataType : "JSON",
        ...
        $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/StudentDetails/fetchProgram",
            dataType : "JSON",
          ...
          $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/StudentDetails/fetchCourseGroup",
            dataType : "JSON",
            ...
            $.ajax({
                type : "POST",
                url: "<?php echo base_url();?>admin/StudentDetails/fetchCourseComponent",
                dataType : "JSON",
