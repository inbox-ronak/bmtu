...
<?php $add_permission = $this->permission->grant(MAGAZINE_SUBSCRIPTION,'add'); ?>
<?php $edit_permission = $this->permission->grant(MAGAZINE_SUBSCRIPTION,'edit'); ?>
<?php $delete_permission = $this->permission->grant(MAGAZINE_SUBSCRIPTION,'delete'); ?>
         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/magazine_subscription">magazine subscription</a></li>
                  <li class="breadcrumb-item active"><?php if(isset($renewal['id'])){ echo 'Update';}else{ echo 'Add'; } ?> magazine subscription</li>
               </ol>
            </div>
         </div>
      </div>
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h3 class="card-title"><?php if(isset($renewal['id'])){ echo 'Update';}else{ echo 'Add'; } ?> magazine Subscription</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body" id="show_data">
                     <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>admin/magazine_subscription/<?php if(isset($renewal['id'])){ echo 'edit/'.base64_encode($renewal['id']);}else{ echo 'add'; } ?>' id="add-form" name="add-form" enctype='multipart/form-data'>
                        <div class="row">
                           <!-- <div class="row"> -->
                           ...
                           <div class="card col-md-12 card-header" >
                              <h5 style="color: blue">Encl: As above.</h5>
                              <label>Encl: DEMAND DRAFT/Cheque.</label>
                              ...
                              <div class="form-row">
                                 <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                       <lable>SMOI Chapter</lable>
                                       <input type="text" name="smoiichapter" class="form-control" id="smoi_chapter" value="<?php if(isset($renewal['smoi_chapter'])){ echo $renewal['smoi_chapter'];} ?>">
                                    </div>
                                    <div class="form-group">
                                 ...
                                 <div class="col-md-4">
                                    <h5 style="color: blue">Space for Central  Office</h5>
                                    <div class="form-group">
