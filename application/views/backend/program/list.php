        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="float-right"><a href="<?php echo base_url();?>admin/Program/add" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus text-xs"></i> Program</a></div>
              <?php } ?>
            </div>
            <!-- /.card-header -->
            <div class="card-body" >
    ...
    $(document).ready(function(){
        ...
        function show_data(){
          $('#modal-loader').modal('hide');
            ...
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/Program/data')?>',
                async : true,
                //dataType : 'json',
        ...
        $('#show_data').on('click','.item_delete',function(){
            ...
            if(confirm('Are you sure want to delete?')){
              $.ajax({
                  type : "POST",
                  url: "<?php echo base_url();?>admin/Program/delete/"+id,
                  dataType : "JSON",
                  data : {id:id},
