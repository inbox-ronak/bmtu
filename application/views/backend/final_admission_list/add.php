...
<?php $add_permission = $this->permission->grant(FINAL_ADMISSION_LIST,'add'); ?> 
<?php $edit_permission = $this->permission->grant(FINAL_ADMISSION_LIST,'edit'); ?>
<?php $delete_permission = $this->permission->grant(FINAL_ADMISSION_LIST,'delete'); ?>
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/FinalAdmissionList">Generate Merit</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
              <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>admin/FinalAdmissionList/<?php if(isset($record['id'])){ echo 'edit/'.base64_encode($record['id']);}else{ echo 'add'; } ?>' id="add-form" name="add-form" enctype='multipart/form-data'>
                <div class="row">
                  <div class="col-md-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $.ajax({
        type : "POST",
        url: "<?php echo base_url();?>admin/FinalAdmissionList/fetchDepartment",
        dataType : "JSON",
        ...
        $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/FinalAdmissionList/fetchProgram",
            dataType : "JSON",
          ...
          $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/FinalAdmissionList/fetchCourseGroup",
            dataType : "JSON",
            ...
            $.ajax({
                type : "POST",
                url: "<?php echo base_url();?>admin/FinalAdmissionList/fetchCourseComponent",
                dataType : "JSON",
