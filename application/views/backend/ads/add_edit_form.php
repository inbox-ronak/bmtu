                        ...
                        <div class="row">
                               <div class="col-lg-6 col-md-6 col-sm-6 item">
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control select2" name="page_slug" id="page_slug"  >
                         ...
                         <?php 
                           $langArr = langArr();
                           $top_ads_array  = array();
                           $top_ads_url_array = array();
                           $i = 0;
                           if(!empty($form_details->top_ads)){
                            $top_ads_array = unserialize($form_details->top_ads);
                            }
                            if(!empty($form_details->top_ads_url)){
                            $top_ads_url_array = unserialize($form_details->top_ads_url);
                            }
                            ...
                            foreach ($langArr as $key => $val) {?>
                                  <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="file" onchange="validate(this.id,'error_top_ads_<?php echo $key; ?>')" name="top_ads_<?php echo $key; ?>" id="top_ads_<?php echo $key; ?>">
                                                    <span class="text-danger" id="error_top_ads_<?php echo $key; ?>"></span>
                                                ...
                                                <div class="col-md-12 top_ads_uploaded_img_<?php echo $key; ?>" id="top_ads_uploaded_img<?php echo $i; ?>" style=" margin-top:10px; ">
                                                    ...
                                                    <div class="col-md-6 upload_img_div upload_img_div_<?php echo $key; ?>" id="upload_img_div">                                
                                                        ...
                                                        if (isset($top_ads_array[$key]) && $top_ads_array[$key]['image'] != '') {
                                                            ...
                                                            $image_path = getImagePath() . 'assets/uploads/ads/thumb/' . $file_name_view;
                                    ...
                                    <div class="form-group">
                                   <label for="link" class="col-sm-6 control-label">
                                    Top Position Image URL
                                       <small style="color: blue; font-weight: bold;"><i> [<?=$val;?>]</i></small><small style="color: blue; font-weight: bold;"></small>
                                   </label>
                                    <div class="col-sm-4">
                                        <?php  
                                        $top_ads_url = '';

                                        if(isset($_POST['top_ads_url_' . $key])){
                                             $top_ads_url = $_POST['top_ads_url_' . $key];
                                        }
                                        else {
                                            if(isset($top_ads_url_array[$key])){
                                              $top_ads_url = $top_ads_url_array[$key];  
                                            }
                                        }
                                         ?>
                                        <input type="text" name="top_ads_url_<?=$key;?>" id="top_ads_url_<?=$key;?>" 
                                        class="form-control" placeholder="Top Position Image URL <?=$val;?> " 
                                        value="<?=$top_ads_url;?>">
                                    </div>
                              </div>
                            <?php } ?>
                         ...
                         <?php 
                           ...
                           $left_ads_url_array = array();
                            if(!empty($form_details->left_ads)){
                            $left_ads_array = unserialize($form_details->left_ads);
                            }

                             if(!empty($form_details->left_ads_url)){
                            $left_ads_url_array = unserialize($form_details->left_ads_url);
                            }
                            ...
                            foreach ($langArr as $key => $val) {?>
                                  <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="file" name="left_ads_<?php echo $key; ?>" id="left_ads_<?php echo $key; ?>" onchange="validate(this.id,'error_left_ads_<?php echo $key; ?>')">
                                                    <span class="text-danger" id="error_left_ads_<?php echo $key; ?>"></span>
                                                ...
                                                <div class="col-md-12 left_ads_uploaded_img_<?php echo $key; ?>" id="left_ads_uploaded_img<?php echo $i; ?>" style=" margin-top:10px; ">
                                                    <div class="col-md-3"></div>
                                                    <span style="color:blue;" ><i><b>Note:</b> Recommended Image size: 150 X 450 </i></span>
                                                    <div class="col-md-6 upload_img_div upload_img_div_<?php echo $key; ?>" id="upload_img_div">                                
                                                        <span class="single-image-wrap">
                                                            <?php
                                   ...
                                   <label for="link" class="col-sm-6 control-label">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        if(isset($_POST['left_ads_url_' . $key])){
                                             $left_ads_url = $_POST['left_ads_url_' . $key];
                                        }
                                        else {
                                            if(isset($left_ads_url_array[$key])){
                                              $left_ads_url = $left_ads_url_array[$key];  
                                            }
                                        }
                                         ?>
                                        <input type="text" name="left_ads_url_<?=$key;?>" id="left_ads_url_<?=$key;?>" 
                                        class="form-control" placeholder="Left Position Image URL <?=$val;?> " 
                                        value="<?=$left_ads_url;?>">
                                    </div>
                              </div>
                            <?php } ?>
                         ...
                         <?php 
                           ...
                           $right_ads_url_array = array();
                          if(!empty($form_details->right_ads)){
                            $right_ads_array = unserialize($form_details->right_ads);
                            }

                             if(!empty($form_details->right_ads_url)){
                              $right_ads_url_array = unserialize($form_details->right_ads_url);
                            }
                            ...
                            foreach ($langArr as $key => $val) {?>
                                  <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="file" name="right_ads_<?php echo $key; ?>" id="right_ads_<?php echo $key; ?>" onchange="validate(this.id,'error_right_ads_<?php echo $key; ?>')">
                                                    <span class="text-danger" id="error_right_ads_<?php echo $key; ?>"></span>
                                   ...
                                   <label for="link" class="col-sm-6 control-label">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        if(isset($_POST['right_ads_url_' . $key])){
                                             $right_ads_url = $_POST['right_ads_url_' . $key];
                                        }
                                        else {
                                            if(isset($right_ads_url_array[$key])){
                                              $right_ads_url = $right_ads_url_array[$key];  
                                            }
                                        }
                                         ?>
                                        <input type="text" name="right_ads_url_<?=$key;?>" id="right_ads_url_<?=$key;?>" 
                                        class="form-control" placeholder="Right Position Image URL <?=$val;?> " 
                                        value="<?=$right_ads_url;?>">
                                    </div>
                              </div>
                            <?php } ?>
                         ...
                         <?php 
                           ...
                           $bottom_ads_url_array = array();
                            if(!empty($form_details->bottom_ads)){
                            $bottom_ads_array = unserialize($form_details->bottom_ads);
                            }
                            if(!empty($form_details->bottom_ads_url)){
                              $bottom_ads_url_array = unserialize($form_details->bottom_ads_url);
                            }
                           $i = 0;
                            foreach ($langArr as $key => $val) {?>
                                  <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="file" name="bottom_ads_<?php echo $key; ?>" id="bottom_ads_<?php echo $key; ?>" onchange="validate(this.id,'error_bottom_ads_<?php echo $key; ?>')">
                                                    <span class="text-danger" id="error_bottom_ads_<?php echo $key; ?>"></span>
                                   ...
                                   <label for="link" class="col-sm-6 control-label">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        if(isset($_POST['bottom_ads_url_' . $key])){
                                             $bottom_ads_url = $_POST['bottom_ads_url_' . $key];
                                        }
                                        else {
                                            if(isset($bottom_ads_url_array[$key])){
                                              $bottom_ads_url = $bottom_ads_url_array[$key];  
                                            }
                                        }
                                         ?>
                                        <input type="text" name="bottom_ads_url_<?=$key;?>" id="bottom_ads_url_<?=$key;?>" 
                                        class="form-control" placeholder="Bottom Position Image URL <?=$val;?> " 
                                        value="<?=$bottom_ads_url;?>">
                                    </div>
                              </div>
                            <?php } ?>
                         <!-- End Page Top Image  -->
...
function validate(id,message_id) {
    // alert("#"+id);
    // alert(message_id);
    $('#'+message_id).html('')
     
    var fileUpload = document.getElementById(id).files[0]['size']
    var filetype = document.getElementById(id).files[0]['type']
    var parts = filetype.split('/');
    // alert(JSON.stringify(parts[1]));
    //var ext = '';
    // var ext = this.filetype.match(/\.(.+)$/)[1];
    switch (parts[1]) {
        case 'jpg':
        case 'jpeg':
        case 'png':
        ...
        break;
        default:
        document.getElementById(message_id).innerHTML='<?php echo $this->lang->line('Invalid file type');?>'
        $('#'+id).val(null);
    } 
} 
