<?php
$cate_name = unserialize($data->title);
$cate_desc = unserialize($data->description);
?>
<div class="row">
<?php
$langArr = langArr();
...
<div class="form-group col-md-6">
 ...
 <?php } ?>
             <!--  <div class="form-group col-md-6">
                ...
                <input type="text" name="title" class="form-control convert-into-slug" data-slug="slug_edit" id="title"  placeholder="Enter faq name" required value="<?php echo $data->title;?>">
              </div> -->
            ...
            <!-- <div class="row">
              <div class="col-md-12">
                <textarea class="textarea summernote" name="description" placeholder="Place some text here" style="width: 100%; height: 700px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $data->description;?></textarea>
              </div>
            </div> -->
