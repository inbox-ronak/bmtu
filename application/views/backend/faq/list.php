...
<?php $add_permission = $this->permission->grant(FAQ,'add'); ?>
<?php $edit_permission = $this->permission->grant(FAQ,'edit'); ?>
<?php $delete_permission = $this->permission->grant(FAQ,'delete'); ?>
<style type="text/css">
  .row_position tr{
    cursor: grab;
  }
...
<div class="content-wrapper">
  ...
  <section class="content">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="float-right"><a href="#" data-toggle="modal" data-target="#modal-default" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus text-xs"></i> Add FAQ</a></div>
              <?php } ?>
            </div>
            <!-- /.card-header -->
    ...
    <div class="modal fade" id="modal-default" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>faq/add' id="add-form" name="add-form" enctype='multipart/form-data'>
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <!-- <div class="form-group col-md-6">
                <label for="title">FAQ Name<span style="color: red">*</span></label>
                <input type="text" name="title" class="form-control convert-into-slug" data-slug="slug" id="title" placeholder="Enter FAQ Name" required>
              </div> -->
              ...
              ?>
                <div class="form-group col-md-6">
                  <div class="form-group">
                    <?php echo form_label('FAQ Name <small style="color: blue; font-weight: bold;"><i> ['. $val.']</i></small>'.$compulsory . ' <small style="color: blue; font-weight: bold;"></small>', 'title_' . $key, array('class' => 'col-sm-12 control-label')); ?>
                        <?php
                          $input_attr = array(
                            'name' => 'title_' . $key,
                            'id' => 'title_' . $key,
           ...
           <!--  <div class="row">
              <div class="col-md-12">
                <textarea class="textarea summernote" name="description" placeholder="Place some text here" style="width: 100%; height: 700px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
            </div> -->
    ...
    <div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form data-toggle="validator" role="form" method='POST' class="form-horizontal2" action='<?php echo base_url();?>faq/update_faq' id="edit-form" name="edit-form" enctype='multipart/form-data'>
          <div class="modal-header">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function show_data(){
          $('#modal-loader').modal('hide');
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/faq/data')?>',
                async : true,
                //dataType : 'json',
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url('admin/faq/getEdit')?>/'+id,
                dataType : 'html',
                success : function(data){
                  $('#editModel').html(data);
                  // edit();
        ...
        //update record to database
         $('#btn_update').on('click',function(event){
            ...
            var formData = new FormData(form);
              $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('admin/faq/update')?>",
                  data: formData,
                  //use contentType, processData for sure.
                  contentType: false,
                  processData: false,
        ...
        $('#show_data').on('click','.item_delete',function(){
            ...
            if(confirm('Are you sure want to delete?')){
              $.ajax({
                  type : "POST",
                  url: "<?php echo base_url();?>admin/faq/delete/"+id,
                  dataType : "JSON",
                  data : {id:id},
                  success: function(msg){
                      success_msg(msg.success,msg.message);
    ...
    function row_position(){
      ...
      function updateOrder(data) {
          $.ajax({
              url:"<?php echo base_url();?>admin/faq/ordering",
              type:'post',
              data:{position:data},
              success:function(data){
