...
<?php $add_permission = $this->permission->grant(MERIT,'add'); ?> 
<?php $edit_permission = $this->permission->grant(MERIT,'edit'); ?>
<?php $delete_permission = $this->permission->grant(MERIT,'delete'); ?>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Merit</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>admin/Merit">Merit</a></li>
            <li class="breadcrumb-item active"><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Merit</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="table-responsive" id="show_data">
              ...
              <h3 class="card-title"><?php if(isset($record['id'])){ echo 'Update';}else{ echo 'Add'; } ?> Merit</h3>
            </div>
            <!-- /.card-header -->
              <form data-toggle="validator" role="form" method='POST' class="form-horizontal" action='<?php echo base_url();?>admin/Merit/<?php if(isset($record['id'])){ echo 'edit/'.base64_encode($record['id']);}else{ echo 'add'; } ?>' id="add-form" name="add-form" enctype='multipart/form-data'>
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="number" min="0" name="merit" class="form-control" required id="merit" placeholder="" value="<?php if(isset($record['merit'])){ echo $record['merit'];} ?>">
                    </div>
                  </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $.ajax({
        type : "POST",
        url: "<?php echo base_url();?>admin/Merit/fetchDepartment",
        dataType : "JSON",
        ...
        $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/Merit/fetchProgram",
            dataType : "JSON",
          ...
          $.ajax({
            type : "POST",
            url: "<?php echo base_url();?>admin/Merit/fetchCourseGroup",
            dataType : "JSON",
            ...
            $.ajax({
                type : "POST",
                url: "<?php echo base_url();?>admin/Merit/fetchCourseComponent",
                dataType : "JSON",
