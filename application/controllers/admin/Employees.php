...
class Employees extends CI_Controller {
	...
	{   
		...
		$permission = $this->permission->grant(EMPLOYEE,'view');
		if($permission == false){
	...
	{ 
		...
		$permission = $this->permission->grant(EMPLOYEE,'delete');
		if($permission == false){
			redirect('admin/dashboard');
		}
...
{   
	...
	$permission = $this->permission->grant(CIRCULARPROCESS,'view');
	if($permission == false){
		redirect('admin/dashboard');
	}

	$data['title']    = $this->lang->line('view');//display('view details');  
	...
	{   
		...
		$data['title']      = $this->lang->line('view_salary_setup');  ;
